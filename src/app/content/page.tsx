      ...
      {tab === 'queue' && (
        <div className="panel">
          ...
          <DataTable
            ...
            keyField="id"
            emptyIcon={PenLine}
            emptyTitle="No content in the queue"
            emptyDescription="Drafts created by you or generated by agents will appear here for review before they are scheduled."
            emptyPrimaryAction={{ label: 'Ask Buzz to draft a post', href: '/dashboard', icon: PenLine }}
          />
          </div>
        </div>
      )}
        ...
        <div className="space-y-4">
          ...
          <div className="panel">
            ...
            <DataTable
              ...
              emptyDescription="Once posts go live they are tracked here with impressions, likes, and engagement rate."
